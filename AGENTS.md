...
- **`clients/`**: The frontend applications are managed with **Turborepo** and **pnpm**.
    ...
    - **`clients/apps/orbit/`**: Documentation and component showcase for the Orbit design system.
    ...
    - **`clients/packages/orbit/`**: Polar's design system containing components, design tokens, etc.
