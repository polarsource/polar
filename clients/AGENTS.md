...
Keep files to 250 lines of code (excluding blanks and comments). If you hit this
limit, refactor the file into smaller pieces — extract sub-components, split hooks
into separate files, or move helpers into their own modules.
...
Truncated for overflow text with an auto-appearing tooltip).
