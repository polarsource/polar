...
export const LandingCTA = () => (
  <section className="border-b border-neutral-800">
    <div className="grid grid-cols-2 divide-x divide-neutral-800">
      <div className="flex flex-col justify-between p-8 py-24">
        <SectionLabel number="005" label="Get Started" />
        <h2 className="mt-16 text-[clamp(2rem,5vw,4.5rem)] font-extralight leading-[1.05] text-white">
          Start billing
          <br />
          in minutes
        </h2>
      ...
      <div className="flex flex-col justify-end gap-6 p-8 py-24">
