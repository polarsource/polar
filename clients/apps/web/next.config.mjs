...
let previewBasePath = ''
console.log('[next.config] VERCEL_GIT_PULL_REQUEST_ID:', process.env.VERCEL_GIT_PULL_REQUEST_ID || '(unset)')
console.log('[next.config] POLAR_PREVIEW_BACKEND_HOST:', process.env.POLAR_PREVIEW_BACKEND_HOST || '(unset)')
if (
