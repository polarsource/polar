const requireCustomerPortalPage = {
  meta: {
    ...
    messages: {
      missing:
        'This customer portal page must render its content inside <CustomerPortalPage>. If this page is intentionally standalone (e.g. an unauthenticated request/authenticate page), add it to the rule ignores in .oxlintrc.json.',
    },
  },
  create(context) {
