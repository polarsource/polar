document.addEventListener('DOMContentLoaded', function () {
  ...
  window.triggerPolarCheckout = function (url, theme) {
  ...
  for (const checkoutElement of document.querySelectorAll('[data-polar-checkout]')) {
    checkoutElement.addEventListener('click', function () {
      const url = checkoutElement.getAttribute('data-polar-checkout');
      const theme = checkoutElement.getAttribute('data-polar-checkout-theme');
      window.triggerPolarCheckout(url, theme);
    });
  }
});
