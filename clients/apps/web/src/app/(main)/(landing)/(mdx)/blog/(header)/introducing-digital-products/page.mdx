...
<InnerHeaderWrapper>
  <h1>Introducing Digital Products</h1>
</InnerHeaderWrapper>

![Introducing digital products](./abstract_05.jpg)
...
> [!TIP] > **Want to integrate Polar on your own site or service instead?** You can use our API & TS SDK to easily integrate everything we have to offer. Just like [Your Next Store](https://yournextstore.com/) has on their gorgeous - custom - page.
