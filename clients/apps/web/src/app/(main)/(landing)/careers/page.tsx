        ...
        <JobSection
          ...
          jobs={[
            ...
            },
            {
              ...
              description: 'Own the end-to-end architecture and implementation of our infrastructure to ensure world-class uptime and latency.',
              location: 'Remote — Europe',
              link: 'https://jobs.ashbyhq.com/polar/e610cfb0-a883-4138-aef0-f826f82958cb',
            },
            {
              role: 'Senior Product Engineer',
              description: 'Ship features, APIs and SDKs that empowers the next generation of developers to build businesses.',
              location: 'Remote — Europe',
            ...
            },
            {
              ...
              description: 'Design and ship growth-focused features, enhancements and experiments end-to-end.',
              location: 'Remote — Europe',
              link: 'https://jobs.ashbyhq.com/polar/1496592e-16ff-47e7-b11e-a993c887fc1f',
            },
            {
              role: 'Senior Product Designer (On-site)',
              description: 'Design the future platform for developers to turn their software into a business.',
              location: 'Stockholm, Sweden',
              link: 'https://jobs.ashbyhq.com/polar/1fee39f0-897c-4bdc-8ec0-a055f5d94a6c',
            },
            {
              role: 'Senior Data Engineer',
              description: 'Design, ship and optimize our internal data warehouse to Metric APIs for developers using Polar.',
              location: 'Remote - Europe',
          ...
          jobs={[
            {
              ...
              description: 'Build, lead, and scale our developer-facing efforts across community, content and advocacy. You’ll be the voice of Polar.',
              location: 'San Francisco - Remote',
              link: 'https://jobs.ashbyhq.com/polar/d09babe6-f727-42ec-b466-cf074f468f19',
            },
            {
              role: 'Community Manager',
              description: 'Nurture and scale our thriving developer community around Polar.',
          ...
          jobs={[
            {
              ...
              description: 'Help provide exceptional support to developers world-wide and scale our efforts by improving docs, guides and internal tooling.',
              location: 'Europe - Remote',
