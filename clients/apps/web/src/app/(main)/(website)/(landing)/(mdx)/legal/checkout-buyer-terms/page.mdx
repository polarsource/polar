...
Polar complies with the U.S. Digital Millennium Copyright Act. To report alleged copyright infringement, please complete our [DMCA Takedown Request Form](https://forms.polar.sh/DMCA-complaint). If you are unable to use the form, you may instead submit a notice to Polar’s designated DMCA agent at [dmca@polar.sh](mailto:dmca@polar.sh) or by mail to: DMCA Agent, Polar Software, Inc., 3500 South DuPont Highway, Dover, DE 19901\.
