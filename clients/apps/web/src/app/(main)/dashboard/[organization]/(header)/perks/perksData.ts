...
export const perksData: Perk[] = [
  {
    id: 'mercury',
    provider: 'Mercury',
    logoUrl: 'https://spaire-production-files-public.s3.us-east-1.amazonaws.com/mercury-logo.svg',
  ...
  },
  {
    ...
    logoUrl: 'https://spaire-production-files-public.s3.us-east-1.amazonaws.com/amazon_web_services_logo.jpeg',
  ...
  },
  {
    id: 'notion',
    provider: 'Notion',
    logoUrl: 'https://spaire-production-files-public.s3.us-east-1.amazonaws.com/notionhq_logo.jpeg',
  ...
  },
  {
    ...
    logoUrl: 'https://spaire-production-files-public.s3.us-east-1.amazonaws.com/stripe_logo.jpeg',
  ...
  },
  {
    id: 'hubspot',
    provider: 'HubSpot',
    logoUrl: 'https://spaire-production-files-public.s3.us-east-1.amazonaws.com/hubspot_logo.jpeg',
  ...
  },
  {
    id: 'posthog',
    provider: 'PostHog',
    logoUrl: 'https://spaire-production-files-public.s3.us-east-1.amazonaws.com/posthog_logo.jpeg',
  ...
  },
  {
    id: 'linear',
    provider: 'Linear',
    logoUrl: 'https://spaire-production-files-public.s3.us-east-1.amazonaws.com/linear.jpeg',
    headline: '6 Months Free',
    description:
  ...
  },
  {
    id: 'intercom',
    provider: 'Intercom',
    logoUrl: 'https://spaire-production-files-public.s3.us-east-1.amazonaws.com/intercom_logo.jpeg',
    headline: '90% Off Year 1',
    description:
  ...
  },
  {
    id: 'vercel',
    provider: 'Vercel',
    logoUrl: 'https://spaire-production-files-public.s3.us-east-1.amazonaws.com/vercel_logo.jpeg',
  ...
  },
  {
    id: 'openai',
    provider: 'OpenAI',
    logoUrl: 'https://spaire-production-files-public.s3.us-east-1.amazonaws.com/open+ai+-+logo.jpg',
  ...
  },
  {
    id: 'airtable',
    provider: 'Airtable',
    logoUrl: 'https://spaire-production-files-public.s3.us-east-1.amazonaws.com/airtable-logo.jpeg',
  ...
  },
  {
    id: 'mixpanel',
    provider: 'Mixpanel',
    logoUrl: 'https://spaire-production-files-public.s3.us-east-1.amazonaws.com/mixpanel_inc__logo.jpeg',
    headline: '$50,000 in Credits',
    description:
