...
- By continuing you agree to our [Terms of Service](https://polar.sh/legal/terms) and [Privacy
  Policy](https://polar.sh/legal/privacy)
...
- [Refer to the deployment guide for production setup](/docs/DEPLOYMENT.md)
