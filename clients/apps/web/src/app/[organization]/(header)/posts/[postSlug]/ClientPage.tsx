...
export default async function Page({ article, products }: PostPageProps) {
  ...
  return (
    <div className="dark:md:bg-polar-900 dark:md:border-polar-800 dark:ring-polar-800 rounded-4xl relative flex w-full flex-col items-center ring-gray-100 md:bg-gray-50 md:p-12 md:shadow-sm md:ring-1 dark:md:border dark:md:ring-1">
      <Link
