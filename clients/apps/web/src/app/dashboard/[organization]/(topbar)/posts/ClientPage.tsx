...
const PostItem = (post: Article) => {
  ...
  return (
    ...
    >
      <div
        className={twMerge(
          'dark:bg-polar-700 dark:hover:bg-polar-800 rounded-4xl flex flex-col justify-between gap-x-8 gap-y-6 bg-white p-8 shadow-sm transition-colors hover:bg-gray-50',
