...
1. Personal Access Tokens: those are long-lived tokens generated from your [user settings](/settings#pat).
...
You can create a client from your [user settings](/settings#oauth).

![OAuth2 Client Creation](/assets/docs/api-reference/authentication/oauth2_client_create.png)
...
![OAuth2 Client ID and Secret](/assets/docs/api-reference/authentication/oauth2_client_id_secret.png)
...
![OAuth2 Authorize Page](/assets/docs/api-reference/authentication/oauth2_authorize.png)
...
```bash
curl -X POST https://api.polar.sh/api/v1/oauth2/token \
...
![OAuth2 Organization Selection](/assets/docs/api-reference/authentication/oauth2_organization_selection.png)
![OAuth2 Organization Authorize Page](/assets/docs/api-reference/authentication/oauth2_organization_authorize.png)
...
Bear in mind that some endpoints might not support organization access tokens. Typically, user-specific endpoints like `/api/v1/users/benefit` will not work with organization access tokens.
</BrowserCallout>
