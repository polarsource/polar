...
![OAuth2 Client Creation](/assets/docs/api/authentication/oauth2_client_create.png)
...
![OAuth2 Client ID and Secret](/assets/docs/api/authentication/oauth2_client_id_secret.png)
...
![OAuth2 Authorize Page](/assets/docs/api/authentication/oauth2_authorize.png)
...
![OAuth2 Organization Selection](/assets/docs/api/authentication/oauth2_organization_selection.png)
![OAuth2 Organization Authorize Page](/assets/docs/api/authentication/oauth2_organization_authorize.png)
