...
![Screenshot of signup page on Polar](../signup.light.jpg)
![Screenshot of signup page on Polar](../signup.dark.jpg)

This signup flow will ensure you:

1. Create a Polar account using your GitHub Login (OAuth)
   _Covered in the next section below._
...
_Covered further down below: [Install GitHub App](#install-the-polar-github-app)_
...
![Screenshot of enabling personal maintainer mode in Polar](../polar-upgrade.light.jpg)
![Screenshot of enabling personal maintainer mode in Polar](../polar-upgrade.dark.jpg)
...
![Screenshot of adding maintainer organizations in Polar](../polar-connect-maintainer-org.light.jpg)
![Screenshot of adding maintainer organizations in Polar](../polar-connect-maintainer-org.dark.jpg)
...
2. **Review & Install Polar App:** For selected repositories under the chosen
   GitHub account or organization. _See below._
