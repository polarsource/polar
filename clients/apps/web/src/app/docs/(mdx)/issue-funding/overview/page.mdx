...
1. [Create an account or enable maintainer mode for an existing Polar
   account](/docs/issue-funding/getting-started#creating-a-new-account)
2. [Install Polar for select
   repositories](/docs/issue-funding/getting-started#install-the-polar-github-app)
3. [Customize the Polar badge & how it's embedded](/docs/issue-funding/getting-started#badge-settings)
4. [Promote funding within your
   community](/docs/issue-funding/promote) (recommended,
   but optional)
...
2. You have public - open source - repositories you want to promote funding
   towards
3. You live in a [country we support](/docs/faq/for-maintainers/#which-countries-are-supported)
