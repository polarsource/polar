...
[onboarding](/docs/issue-funding/getting-started#install-the-polar-github-app) & keeps them up-to-date
...
2. Click `Add badge` for the desired issue in your Polar dashboard
   ...
   _This will automatically open the [customiztion modal](#customize-badge) below._

Almost instantly the Polar Badge is embedded at the end of
the GitHub issue description by the Polar GitHub App you've
[installed](/docs/issue-funding/getting-started#install-the-polar-github-app) 🎉
...
your [default
settings](/docs/issue-funding/getting-started#badge-settings). Just click the
