...
Sell ads ("logo in README") to your subscribers with the Advertisement benefit.

### Create an ads benefit

![Create an ad benefit](/assets/docs/maintainers/ads/create-benefit-dark.png#only-dark)
![Create an ad benefit](/assets/docs/maintainers/ads/create-benefit-light.png#only-light)
...
![Configure ad](/assets/docs/maintainers/ads/configure-ad-dark.png#only-dark)
![Configure ad](/assets/docs/maintainers/ads/configure-ad-light.png#only-light)
...
curl -s -H "Authorization: Bearer YOUR_TOKEN_HERE" \
    "https://api.polar.sh/v1/advertisements/campaigns/search?organization_name=YOUR_GITHUB_USERNAME_HERE&platform=github&subscription_benefit_id=YOUR_BENEFIT_ID_HERE"
```
