...
2. Click `Enable donations` and that's it. New to Polar? Please goto `Finance` and start setting up Stripe too - ensuring you're in a [supported country](https://docs.polar.sh/faq/maintainers/#which-countries-are-supported) for payouts.
