...
## Review Backlog
![Polar Issue Progress Overview](/assets/docs/maintainers/issue-funding/polar-issue-progress-light.jpg#only-light)
![Polar Issue Progress Overview](/assets/docs/maintainers/issue-funding/polar-issue-progress-dark.jpg#only-dark)

Polar synchronizes all of your issues during
[onboarding](/docs/overview/issue-funding/getting-started#install-the-polar-github-app) & keeps them up-to-date
...
[settings](/docs/overview/issue-funding/getting-started#embed-settings)
...
[installed](/docs/overview/issue-funding/getting-started#install-the-polar-github-app) 🎉

![Polar Badged Issue in Dashboard](/assets/docs/maintainers/issue-funding/polar-issue-badged-light.jpg#only-light)
![Polar Badged Issue in Dashboard](/assets/docs/maintainers/issue-funding/polar-issue-badged-dark.jpg#only-dark)
...
your [default
settings](/docs/overview/issue-funding/getting-started#badge-settings). Just click the
...
#### Funding
![Polar Badge Issues Customization](/assets/docs/maintainers/issue-funding/polar-issue-badge-custom-light.jpg#only-light)
![Polar Badge Issues Customization](/assets/docs/maintainers/issue-funding/polar-issue-badge-custom-dark.jpg#only-dark)

##### Badge Description

You can easily tweak or even completely change the default description you setup
during
[onboarding](/docs/overview/issue-funding/getting-started#markdown-description)
...
![Polar Badge Reward Setup](/assets/docs/maintainers/issue-funding/polar-issue-rewards-light.jpg#only-light)
![Polar Badge Reward Setup](/assets/docs/maintainers/issue-funding/polar-issue-rewards-dark.jpg#only-dark)
...
![Polar Issue Funding Promotion](/assets/docs/maintainers/issue-funding/polar-issue-promote-light.jpg#only-light)
![Polar Issue Funding Promotion](/assets/docs/maintainers/issue-funding/polar-issue-promote-dark.jpg#only-dark)
...
![Polar Issue Progress Overview](/assets/docs/maintainers/issue-funding/polar-issue-completed-light.jpg#only-light)
![Polar Issue Progress Overview](/assets/docs/maintainers/issue-funding/polar-issue-completed-dark.jpg#only-dark)
...
![Polar Issue Reward Contributors](/assets/docs/maintainers/issue-funding/polar-reward-prompt-light.jpg#only-light)
![Polar Issue Reward Contributors](/assets/docs/maintainers/issue-funding/polar-reward-prompt-dark.jpg#only-dark)
...
![Polar Issue Reward Comment](/assets/docs/maintainers/issue-funding/polar-reward-comment-light.jpg#only-light)
![Polar Issue Reward Comment](/assets/docs/maintainers/issue-funding/polar-reward-comment-dark.jpg#only-dark)
