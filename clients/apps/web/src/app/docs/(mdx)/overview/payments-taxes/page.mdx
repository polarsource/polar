...
![Polar Account Setup](../..//assets/docs/maintainers/issue-funding/polar-account-nudge-light.jpg#only-light)
![Polar Account Setup](../..//assets/docs/maintainers/issue-funding/polar-account-nudge-dark.jpg#only-dark)
...
![Polar Stripe Account Setup](../..//assets/docs/maintainers/issue-funding/polar-account-stripe-setup-light.jpg#only-light)
![Polar Stripe Account Setup](../..//assets/docs/maintainers/issue-funding/polar-account-stripe-setup-dark.jpg#only-dark)

Stripe is the default and recommended option since it enables instant transfers.

##### Open Collective

![Polar Stripe Account Setup](../..//assets/docs/maintainers/issue-funding/polar-account-oc-setup-light.jpg#only-light)
![Polar Stripe Account Setup](../..//assets/docs/maintainers/issue-funding/polar-account-oc-setup-dark.jpg#only-dark)
...
![Polar Balance](../..//assets/docs/payment/polar-balance-light.jpg#only-light)
![Polar Balance](../..//assets/docs/payment/polar-balance-dark.jpg#only-dark)
