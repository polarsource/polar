...
export default async function Page({
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center">
      <div className="md:rounded-4xl md:dark:border-polar-700 md:dark:bg-polar-900 grid w-full max-w-7xl grid-cols-1 gap-y-12 p-12 md:grid-cols-3 md:gap-x-32 md:border md:border-gray-100 md:bg-gray-50 md:py-12 md:pl-12 md:pr-0">
        ...
        <div className="dark:bg-polar-950 dark:border-polar-700 rounded-4xl col-span-2 hidden overflow-hidden rounded-r-none border border-r-0 border-gray-100 bg-gray-100 py-2 pl-2 md:flex">
