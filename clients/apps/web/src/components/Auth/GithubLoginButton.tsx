...
const GithubLoginButton = (props: {
  ...
  return (
    <a
      href={authorizeURL}
      className={twMerge(
        `flex content-center items-center justify-center rounded-full bg-blue-500 text-white transition-all duration-100 hover:bg-blue-400 hover:opacity-85 dark:bg-blue-500 dark:text-white dark:hover:bg-blue-400 dark:hover:text-white
