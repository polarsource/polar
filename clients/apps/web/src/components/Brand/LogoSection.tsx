  ...
  return (
    <SectionLayout label="Logo">
      <div className="grid h-full w-full flex-1 grid-cols-1 gap-8 xl:grid-cols-3">
        ...
        <div
          className="dark:bg-polar-900 flex aspect-square h-full cursor-auto items-center justify-center bg-neutral-100"
