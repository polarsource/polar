...
import {
  BASED_ON,
  BASELINE_LEVERS,
} from '@/components/Void/Simulation/fixture/baseline'
import {
  applyChanges,
  describeChange,
} from '@/components/Void/Simulation/fixture/fromCompass'
import { useScenarios } from '@/components/Void/Simulation/fixture/store'
...
export const SimulationBlockViewFixture = ({
  block,
  organization,
}: {
