  ...
  return (
    <div
      ...
      className={
        ...
        (props.active
          ? 'dark:bg-polar-500 dark:text-polar-100 dark:hover:bg-polar-400 bg-gray-50/90 text-gray-900 drop-shadow hover:bg-gray-50 hover:text-gray-900 dark:hover:text-white'
