      ...
      >
        ...
        >
          ...
          >
            ...
            {showFundingGoal ? (
              <FundingGoal funding={funding} darkmode={darkmode} />
            ) : null}
          </div>
    ...
    {showAvatars.map((url, idx) => (
      <img
        ...
        style={{
          ...
          width: 22,
          borderRadius: 22,
          border: darkmode ? '1px solid #1B1D29' : '1px solid white',
    ...
    {extraAvatarsCount > 0 && (
      <div
        style={{
          ...
          fontSize: '8px',
          lineHeight: '20px',
          border: darkmode ? '1px solid #13151D' : '1px solid white',
          display: 'flex',
          alignItems: 'center',
...
const FundingGoal = ({
  ...
  const progress =
    funding.pledges_sum && funding.funding_goal
      ? Math.max(
          Math.min(
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ${getCentsInDollarString(funding.pledges_sum.amount, false, true)}
          &nbsp;
        </span>
        <span
          style={{
        ...
        >
          / ${getCentsInDollarString(funding.funding_goal.amount, false, true)}{' '}
          pledged
        </span>
      </div>
  ...
  >
    ...
    >
      <span style={{ whiteSpace: 'pre' }}>
        $
        {getCentsInDollarString(funding?.pledges_sum?.amount ?? 0, false, true)}
        &nbsp;
      </span>
      <span
        style={{
