...
export const Post = (props: FeedPost) => {
  ...
  return (
    <div
      className={twMerge(
        'dark:border-polar-800 hover:dark:bg-polar-800/60 flex w-full flex-col justify-start gap-6 rounded-3xl border border-gray-100 p-8 transition-colors duration-100 hover:bg-gray-50 md:flex-row',
