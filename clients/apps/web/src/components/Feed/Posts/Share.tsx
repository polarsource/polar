      ...
      <div className={classNames}>
        ...
        {isOpen && (
          <div
            ref={ref}
            className={twMerge(
              'dark:bg-polar-800 dark:text-polar-400 dark:border-polar-700 absolute left-0 top-12 z-50 w-[300px] overflow-hidden rounded-2xl bg-gray-50 p-2 shadow-xl dark:border',
            )}
          >
            <LinkItem
