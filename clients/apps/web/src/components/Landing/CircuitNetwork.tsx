...
// ── Colors ───────────────────────────────────────────────────────────────────
const CHIP_TOP =
  'bg-gray-100 dark:bg-polar-900 border-[0.5px] border-gray-300 dark:border-polar-700'
      ...
      >
        <Isometric style={{ width: SW, height: SH }}>
            ...
            <defs>
              ...
              >
                <circle
                  ...
                  r="0.85"
                  fill="currentColor"
                  className="dark:text-polar-800 text-gray-300"
                />
              </pattern>
            </defs>
          ...
          <IsometricBox
            ...
            y={HUB_PLATFORM.y}
            z={HUB_PLATFORM.z}
            width={HUB_PLATFORM.w}
            height={HUB_PLATFORM.h}
            depth={HUB_PLATFORM.d}
