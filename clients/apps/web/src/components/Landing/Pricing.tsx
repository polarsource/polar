...
const tiers: PricingTier[] = [
  ...
  },
  {
    ...
    price: '$299',
    period: '/month',
    description: 'For AI teams scaling to production.',
    features: [
  ...
  },
  {
    ...
    price: '$999',
    period: '/month',
    description: 'For high-volume AI companies.',
    features: [
...
const EnterpriseCard = () => {
  return (
    <div className="dark:bg-polar-950 relative col-span-1 flex min-h-[280px] items-center justify-center md:col-span-3 md:p-12">
