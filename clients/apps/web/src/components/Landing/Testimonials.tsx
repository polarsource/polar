...
const Testamonial = ({
  ...
  return (
    <Link
      href={link}
      target="_blank"
      className="dark:bg-polar-900 dark:border-polar-700 dark:hover:bg-polar-800 flex flex-row gap-x-4 rounded-2xl border border-white bg-gray-50 p-6 transition-colors hover:bg-white"
    >
...
export const Testimonials = () => {
  return (
    <div className="flex flex-col items-center gap-y-24">
      <h3 className="text-center text-2xl leading-snug md:text-4xl">
