...
export const companyTestimonials = [
  {
    ...
    text: (
      <>
        <p>
          Polar&apos;s Python SDK and Webhook infrastructure made our billing integration
          straightforward.
        </p>
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <p>I went from dreading payments to having everything live in a weekend.</p>
      </>
    ),
  },
];
...
const userTestimonials = [
  {
    ...
    text: (
      <p>
        The speed at which Polar is executing on the financial infrastructure primitives the new
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <p>
          I think it benefits everyone for devs to have more options to get paid to work on their
          passions, to support upstreams, and for users to have more confidence/transparency in the
          software they&apos;re supporting/purchasing.
        </p>
      </>
    ),
  },
    ...
    {userTestimonials.map((t, i) => (
      ...
      >
        ...
        <div>
          ...
          <div className="dark:text-polar-400 text-lg text-gray-400">{t.company}</div>
        </div>
      </Link>
    ))}
  </div>
