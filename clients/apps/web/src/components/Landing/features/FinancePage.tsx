...
export const FinancePage = () => {
  return (
    <FeaturePageLayout>
      ...
      <FeaturePageIntro>
        Every order, refund, fee, and payout is recorded on a single page, with each fee shown next
        to the entry that triggered it. Nothing is hidden, including the fees we pass through from
        Stripe.
      </FeaturePageIntro>

      <FeatureSection title="The ledger">
        <p>
          Your <strong>Finance</strong> page tracks earnings net of VAT (which is captured for
          remittance) and net of our revenue share. The number you see at the top is the amount
          actually available for payout.
        </p>
        <p>
          Below the balance, every transaction sits in chronological order with the associated fees
          broken out next to it. The same data is exposed through the API, so accounting tools can
          pull the equivalent ledger without screen-scraping the dashboard.
        </p>
        <p>
          Multi-currency orders are converted to USD at the rate at the time of the transaction,
          which keeps your settlement currency stable even if your customer base is global.
        </p>
        <p>
          Payouts are deliberately manual. Polar never sweeps your balance automatically, so you
          control when money moves to your connected account.
        </p>
      </FeatureSection>
        ...
        cards={[
          {
            ...
            title: "Live balance",
            description: "See exactly what is payable right now, net of every fee.",
          },
          {
            icon: <ReceiptOutlined fontSize="large" />,
            title: "Transactions ledger",
            description: "Every order, refund, dispute, and fee in chronological order.",
          },
          {
          ...
          },
          {
            ...
            description: "Every fee shown next to the transaction that triggered it.",
          },
        ]}
      />
      ...
      <FeatureSplit
        ...
        bullets={[
          ...
          },
          {
            ...
            description: "You decide when to withdraw, which makes reconciliation simpler.",
          },
          {
            title: "Multi-currency settlement",
            description: "Customers pay in their currency. Polar settles to USD on your account.",
          },
          {
      ...
      <FeatureRichList
        ...
        items={[
          ...
          },
          {
            ...
            description: "+0.5% on recurring charges. A pass-through from Stripe.",
          },
          {
            title: "Refunds",
            description:
      ...
      <FeatureCTA title="Set up payouts" description="Connect a payout account." />
    </FeaturePageLayout>
  );
};
