...
export const MerchantOfRecordPage = () => {
  return (
    <FeaturePageLayout>
      ...
      <FeaturePageIntro>
        Most jurisdictions tax digital sales, and the rules differ country by country. Polar takes
        the role of reseller for those sales, which moves the international tax liability off your
        balance sheet onto ours.
      </FeaturePageIntro>

      <FeatureSection title="What Merchant of Record actually means">
        <p>
          A Payment Service Provider like Stripe routes money between your customer and your bank.
          It&apos;s a powerful abstraction for processing transactions, but it stops there: the
          merchant on every receipt is still you, which means the tax liability for every
          international sale is also still yours.
        </p>
        <p>
          A Merchant of Record sits one layer higher. Polar buys the digital good from you and
          resells it to your customer, which makes us the merchant for that specific sale. As a
          consequence, international sales tax (VAT, GST, US Sales Tax, and the rest) is owed by us,
          not you.
        </p>
        <p>
          What stays with you is the customer relationship. The renewals, the support, and the
          product experience are all yours. We sit underneath, handling the regulatory layer the
          customer never has to think about.
        </p>
      </FeatureSection>
      ...
      <FeatureCardGrid
        cards={[
          ...
          },
          {
            ...
            description: "We're on the hook for capturing and remitting international sales tax.",
          },
          {
            icon: <VerifiedOutlined fontSize="large" />,
            title: "EU B2B reverse charge",
            description: "VAT-registered EU businesses get reverse-charge handling automatically.",
          },
        ]}
      />
