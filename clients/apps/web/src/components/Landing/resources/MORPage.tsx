...
const Benefit = ({
	...
	return (
		<li
			className={twMerge(
				"flex items-start flex-row gap-x-2",
				positive ? "" : "text-gray-400 dark:text-polar-500",
			)}
		>
			{positive ? (
		...
		<ResourceLayout title="Polar as a Merchant of Record" toc={tocItems}>
				...
				<div className="flex flex-col gap-y-6">
					<div className="flex flex-col gap-4">
						...
						<p className="dark:text-polar-300 text-gray-500">
							...
							PSPs and transactions. E.g Polar is built on Stripe (+ more PSPs
							in the future).
						</p>
					</div>
					<div className="flex flex-col gap-2">
				...
				<div className="flex flex-col gap-y-6">
					...
					<div className="flex flex-col gap-2">
						<ul className="divide-y divide-gray-200 border-y border-gray-200 dark:divide-gray-700 dark:border-gray-700 [&>li]:py-2">
							...
							<Benefit>
								You&apos;re fine with handling international taxes yourself.
							</Benefit>
						</ul>
					</div>
			...
			>
				...
				<div className="flex flex-col gap-2">
					<h3>Capturing</h3>
					<p className="dark:text-polar-300 text-gray-500">
						Charging the Swedish consumer \$12.5/month and saving \$2.5/month
						for the Swedish tax authorities. Stripe Tax is an excellent service
				...
				<div className="flex flex-col gap-2 border-t border-gray-200 dark:border-polar-700 pt-4">
					<p className="dark:text-polar-300 text-gray-500">
