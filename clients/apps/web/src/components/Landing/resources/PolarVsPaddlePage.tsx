...
export const PolarVsPaddlePage = () => {
  const toc = [
    ...
    { id: 'migration-guide', title: 'Migration from Paddle' },
  ]

  return (
    <ResourceLayout title="Polar vs Paddle" toc={toc}>
      <ResourceSection id="overview" title="Overview">
        <div className="flex flex-col gap-4">
          <p className="text-lg">
            Both Polar and Paddle are Merchant of Record (MoR) platforms
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li className="flex items-start gap-2">
                  <CheckOutlined
                    ...
                    fontSize="small"
                  />
                  <span>4% + 40¢ per transaction</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckOutlined
                    className="mt-0.5 text-green-500"
            ...
            <div className="dark:bg-polar-700 rounded-lg bg-gray-100 p-6">
              <h3 className="mb-3 text-lg font-semibold">Paddle</h3>
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
      ...
      <ResourceSection id="pricing-comparison" title="Pricing Comparison">
        <div className="flex flex-col gap-6">
          <p>
            ...
            Paddle. Polar offers transparent, developer-friendly pricing
            ...
            <table className="w-full">
              <thead>
                <tr className="dark:bg-polar-800 bg-gray-50">
                  ...
                  <th className="px-4 py-3 text-left">Paddle</th>
                </tr>
              </thead>
          ...
          <div className="dark:bg-polar-800 rounded-lg bg-blue-50 p-6">
            ...
            <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
              ...
              <div>
                <p className="font-medium">With Paddle:</p>
            ...
            <table className="w-full">
              <thead>
                <tr className="dark:bg-polar-800 bg-gray-50">
                  ...
                  <th className="px-4 py-3 text-center">Paddle</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                <tr>
      ...
      <ResourceSection id="developer-experience" title="Developer Experience">
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
              <h4 className="mb-3 font-semibold">Paddle</h4>
...
product = polar.products.create({
  ...
  "prices": [{
    ...
    "interval": "month"
              ...
              <div>
                <p className="mb-2 text-sm font-medium">Paddle (HTTP)</p>
                <pre className="overflow-x-auto rounded bg-white p-3 text-xs dark:bg-gray-700">
                  {`curl -X POST \\
  https://api.Paddle.com/v1/products \\
  ...
  -d '{
    "data": {
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="rounded-lg bg-blue-50 p-6 dark:bg-blue-900">
            <p className="text-sm">
              ...
              location, while Paddle may have variable fees for different
              regions.
            </p>
          </div>
        </div>
      ...
      <ResourceSection id="checkout-experience" title="Checkout Experience">
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
              <h4 className="mb-3 font-semibold">Paddle Checkout</h4>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-start gap-2">
                  <span className="mt-0.5 text-gray-500">•</span>
      ...
      <ResourceSection id="payout-flexibility" title="Payout Flexibility">
        <div className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="dark:bg-polar-700 rounded-lg bg-gray-100 p-6">
              <h4 className="mb-3 font-semibold">Paddle Payouts</h4>
              <ul className="space-y-2 text-sm">
      ...
      <ResourceSection id="migration-guide" title="Migration from Paddle">
        <div className="flex flex-col gap-6">
          <p>
            Switching from Paddle to Polar is straightforward thanks to our
            comprehensive APIs and migration tools.
          </p>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                <ul className="space-y-1 text-sm">
                  <li>□ Export customer data from Paddle</li>
          ...
          <div className="rounded-lg bg-green-50 p-6 dark:bg-green-900">
            ...
            <p className="mb-4 text-sm">
              ...
              switch from Paddle to Polar with zero downtime.
            </p>
            <Link
              href="mailto:support@polar.sh?subject=Migration%20from%20Paddle"
