      ...
      <FocusLock>
        ...
        >
          ...
          >
            ...
            <motion.div
              className={twMerge(
                'dark:bg-polar-950 dark:border-polar-700 relative z-10 flex max-h-full w-full flex-col overflow-hidden rounded-none bg-white shadow lg:w-[800px] lg:max-w-full dark:border',
                className,
              )}
