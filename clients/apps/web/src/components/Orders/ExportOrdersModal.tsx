...
import ExportOrdersColumns, {
  ALL_EXPORT_COLUMNS,
  DEFAULT_EXPORT_COLUMNS,
  ExportColumn,
  orderExportColumns,
  summarizeExportColumns,
} from './ExportOrdersColumns'
...
const ExportOrdersModal: React.FC<ExportOrdersModalProps> = ({
  ...
  const onExport = () => {
    ...
    for (const column of orderExportColumns(columns)) {
      ...
      modalContent={
        <>
          ...
          <Box
            ...
            paddingBottom="2xl"
          >
            <Text color="muted">Download your orders as a CSV file.</Text>
