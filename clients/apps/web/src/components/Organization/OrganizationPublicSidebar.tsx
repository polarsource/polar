...
export const OrganizationPublicSidebar = ({
  ...
  return (
    <div className="flex h-full w-full flex-col items-start justify-between gap-y-6 md:max-w-[18rem]">
      <div className="flex w-full flex-col gap-y-6">
        <div className="flex w-full flex-row items-center gap-x-4 gap-y-6 md:flex-col md:items-start md:gap-x-0">
          ...
          <div className="flex flex-col gap-y-1">
            <h1 className="dark:text-polar-50 text-xl text-gray-800 md:text-xl">
              {organization.pretty_name ?? organization.name}
            </h1>
            {organization.pretty_name && (
              <Link
                className="dark:text-polar-500 text-gray-400 hover:text-blue-500 dark:hover:text-blue-400"
        ...
        <div
          className={twMerge(
            'flex w-full flex-col items-start gap-y-6',
      ...
      <div className="flex flex-row flex-wrap items-center gap-2.5 text-lg">
        ...
        <Button
          className="dark:bg-polar-700 dark:hover:bg-polar-600 dark:text-polar-200 hover:bg-gray-75 flex h-10 w-10 flex-col items-center justify-center rounded-full border-none bg-white text-gray-500 transition-colors"
...
const SocialLink = (props: PropsWithChildren<{ href: string }>) => {
  return (
    <Link
      ...
      className="dark:bg-polar-700 dark:hover:bg-polar-600 dark:text-polar-200 hover:bg-gray-75 flex h-10 w-10 flex-col items-center justify-center rounded-full bg-white text-gray-500 transition-colors"
      href={props.href}
    >
      {props.children}
    </Link>
