...
export const ProductCard = ({
  ...
  return (
    <div className="dark:hover:bg-polar-800 dark:bg-polar-900 flex h-full w-full flex-col gap-6 overflow-hidden rounded-3xl bg-white p-6 transition-colors hover:bg-gray-50">
