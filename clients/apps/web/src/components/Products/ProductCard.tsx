...
export const ProductCard = ({
  ...
  return (
    <div className="dark:hover:bg-polar-800 dark:bg-polar-900 dark:border-polar-700 rounded-4xl flex h-full w-full flex-col gap-6 overflow-hidden p-6 transition-colors hover:bg-gray-50">
