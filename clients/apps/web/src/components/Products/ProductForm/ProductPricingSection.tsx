...
> = ({ organization, index }) => {
  ...
  return (
    <>
      ...
      <FormField
        control={control}
        name={`prices.${index}.included_units`}
        rules={{
          min: 0,
          required: 'This field is required',
        }}
        render={({ field }) => {
          return (
            <FormItem>
              <FormLabel>Included units</FormLabel>
              <FormControl>
                <Input
                  type="number"
                  min={0}
                  ...
                  {...field}
                  onChange={(v) => {
                    const parsedValue = Number.parseInt(v.target.value, 10)
                    field.onChange(
              ...
              <FormDescription>
                Number of units included in the price. They will be deducted
                from the total.
              </FormDescription>
              <FormMessage />
            </FormItem>
