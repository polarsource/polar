...
export const CreatorCard = ({
  ...
  return (
    <Card
      ...
      className={twMerge(
        'dark:text-polar-500 dark:hover:text-polar-300 transition-color dark:hover:bg-polar-900 flex flex-col rounded-none text-gray-500 hover:bg-gray-50 hover:text-gray-600',
