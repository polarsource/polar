import { RefundReason, RefundStatus } from '@polar-sh/api'

export const RefundStatusDisplayTitle: Record<RefundStatus, string> = {
  succeeded: 'Succeeded',
  pending: 'Pending',
  failed: 'Failed',
  canceled: 'Canceled',
...
export const RefundStatusDisplayColor: Record<RefundStatus, string> = {
...
export const RefundReasonDisplay: Record<RefundReason, string> = {
  duplicate: 'Duplicate',
