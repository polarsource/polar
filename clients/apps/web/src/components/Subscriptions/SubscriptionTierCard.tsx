...
const SubscriptionTierCard: React.FC<SubscriptionTierCardProps> = ({
  ...
  return (
    <Card
      ...
      className={twMerge(
        'dark:border-polar-700 relative flex flex-col gap-y-6 overflow-hidden rounded-3xl border-gray-100 bg-gray-50 dark:bg-transparent',
        ...
        <div className="flex flex-col gap-y-8 text-[--var-fg-color] dark:text-[--var-dark-fg-color]">
          {price && (
            <div className={variantStyles[variant]['priceLabel']}>
              ...
              <span className="dark:text-white0 ml-2 text-xl font-normal text-gray-500">
          ...
          {subscriptionTier.description ? (
            <p
              className={twMerge(
                ...
                'dark:text-white0 leading-relaxed text-gray-500',
              )}
            >
              {subscriptionTier.description}
            </p>
