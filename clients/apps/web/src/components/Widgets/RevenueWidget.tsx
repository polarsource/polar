      ...
      <div className="grid h-full grid-cols-3 gap-4 lg:grid-cols-6 lg:gap-6">
        {revenueMetrics.data?.periods.map((period, index, array) => {
          ...
          return (
            ...
            >
              <Tooltip>
                <TooltipTrigger className="relative h-full min-h-48 overflow-hidden rounded-2xl bg-[repeating-linear-gradient(45deg,rgba(0,0,0,0.04),rgba(0,0,0,0.04)_10px,transparent_10px,transparent_20px)] dark:bg-[repeating-linear-gradient(45deg,rgba(255,255,255,0.03),rgba(255,255,255,0.03)_10px,transparent_10px,transparent_20px)]">
