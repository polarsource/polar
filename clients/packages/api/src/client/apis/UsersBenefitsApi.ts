...
export class UsersBenefitsApi extends runtime.BaseAPI {
     ...
     * List Benefits
     */
    async listRaw(requestParameters: UsersBenefitsApiListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListResourceUserBenefit>> {
        const queryParameters: any = {};
     ...
     * List Benefits
     */
    async list(requestParameters: UsersBenefitsApiListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListResourceUserBenefit> {
