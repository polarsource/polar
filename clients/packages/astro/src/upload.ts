 ...
 * the Polar SDK.
 */
import type { ArticleCreate, ArticleUpdate, PolarAPI } from '@polar-sh/sdk'
...
type UploadFilterFunction<TEntry, TArticle extends PolarArticle> = (
...
> {
  ...
  private withFunction<NewTArticle extends PolarArticle>(
    ...
    return new PolarUploadBuilder(this.client, this.entries, [
      ...this.pipeline,
      func,
    ])
  }
  ...
  public transform<NewTArticle extends PolarArticle>(
    ...
    return this.withFunction<NewTArticle>(this, {
      type: 'transform',
