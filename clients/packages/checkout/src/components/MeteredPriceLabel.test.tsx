...
describe('MeteredPriceLabel', () => {
  ...
  describe('tiered prices', () => {
    const tieredPrice = (
      tier_type: 'graduated' | 'volume',
      tiers: { up_to: number | null; price_per_unit: string }[],
    ...
    it('discounts the first tier rate', () => {
      const price = tieredPrice('graduated', [
        { up_to: 1000, price_per_unit: '1000' },
        { up_to: null, price_per_unit: '100' },
      ])
