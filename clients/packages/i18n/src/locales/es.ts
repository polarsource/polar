  ...
  checkout: {
    ...
    benefits: {
      ...
      licenseKey: {
        ...
        rotate: 'Regenerar',
        rotateConfirmTitle: '¿Regenerar esta clave de licencia?',
        ...
        rotateSuccessTitle: 'Clave de licencia regenerada',
        ...
        rotateFailedTitle: 'Error al regenerar la clave de licencia',
      },
      slackSharedChannel: {
