export default {
  "checkout": {
    "footer": {
      ...
      "merchantOfRecord": "Cette commande est traitée par notre revendeur en ligne et commerçant enregistré, Polar, qui gère également les demandes et les retours liés à la commande.",
      "mandateSubscriptionTrial": "En cliquant sur « {buttonLabel} », vous autorisez Polar Software, Inc., notre revendeur en ligne et marchand officiel, à débiter votre moyen de paiement sélectionné du montant indiqué ci-dessus à la fin de votre période d'essai et à chaque date de facturation ultérieure jusqu'à annulation. Vous pouvez annuler à tout moment avant la fin de votre essai pour éviter d'être débité.",
      "mandateSubscription": "En cliquant sur « {buttonLabel} », vous autorisez Polar Software, Inc., notre revendeur en ligne et marchand officiel, à débiter immédiatement votre moyen de paiement sélectionné du montant indiqué ci-dessus et à débiter le même montant à chaque date de facturation ultérieure jusqu'à annulation.",
      "mandateOneTime": "En cliquant sur « {buttonLabel} », vous autorisez Polar Software, Inc., notre revendeur en ligne et marchand officiel, à débiter votre moyen de paiement sélectionné du montant indiqué ci-dessus. Il s'agit d'un paiement unique.",
      "buyerTermsAgreement": "Vous acceptez également les",
    ...
    "benefits": {
      ...
      "licenseKey": {
        ...
        "copiedToClipboardDescription": "La clé de licence a été copiée dans le presse-papiers",
        "loading": "Chargement...",
        "status": "Statut",
        ...
        "activationDeactivationFailed": "Échec de la désactivation de l'activation"
      }
    },
    "confirmation": {
      ...
      "failedTitle": "Un problème est survenu lors du traitement de votre commande",
      "processingDescription": "Veuillez patienter pendant que nous confirmons votre paiement.",
      "successDescription": "Vous êtes maintenant éligible aux avantages de {product}.",
    ...
    "loading": {
      ...
      "confirmationTokenFailed": "Échec de la création du jeton de confirmation, veuillez réessayer plus tard."
    },
    "cta": {
