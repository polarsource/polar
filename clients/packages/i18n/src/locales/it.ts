export default {
  "checkout": {
    "footer": {
      ...
      "merchantOfRecord": "Questo ordine è elaborato dal nostro rivenditore online e Merchant of Record, Polar, che gestisce anche le richieste relative agli ordini e i resi.",
      "mandateSubscriptionTrial": "Cliccando su \"{buttonLabel}\", autorizzi Polar Software, Inc., il nostro rivenditore online e merchant of record, ad addebitare sul metodo di pagamento selezionato l'importo sopra indicato al termine del periodo di prova e a ogni successiva data di fatturazione fino alla disdetta. Puoi annullare in qualsiasi momento prima della fine della prova per evitare l'addebito.",
      "mandateSubscription": "Cliccando su \"{buttonLabel}\", autorizzi Polar Software, Inc., il nostro rivenditore online e merchant of record, ad addebitare immediatamente sul metodo di pagamento selezionato l'importo sopra indicato e ad addebitare lo stesso importo a ogni successiva data di fatturazione fino alla disdetta.",
      "mandateOneTime": "Cliccando su \"{buttonLabel}\", autorizzi Polar Software, Inc., il nostro rivenditore online e merchant of record, ad addebitare sul metodo di pagamento selezionato l'importo sopra indicato. Si tratta di un addebito una tantum.",
      "buyerTermsAgreement": "Accetti inoltre i",
      "buyerTermsLink": "Termini per gli acquirenti"
    },
    "form": {
      "email": "Email",
    ...
    "benefits": {
      ...
      "licenseKey": {
        ...
        "copiedToClipboardDescription": "La chiave di licenza è stata copiata negli appunti",
        "loading": "Caricamento...",
        "status": "Stato",
    ...
    "confirmation": {
      ...
      "failedTitle": "Si è verificato un problema durante l'elaborazione dell'ordine",
    ...
    "loading": {
      ...
      "paymentSuccessful": "Pagamento riuscito! Preparazione dei prodotti in corso...",
      "confirmationTokenFailed": "Impossibile creare il token di conferma, riprova più tardi."
    },
    "cta": {
