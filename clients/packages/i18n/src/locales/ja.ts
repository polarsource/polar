  ...
  checkout: {
    ...
    benefits: {
      ...
      licenseKey: {
        ...
        rotate: '更新',
        rotateConfirmTitle: 'このライセンスキーを更新しますか？',
        rotateConfirmDescription:
          '新しいキーが生成されます。以前のキーはすぐに認証されなくなります。更新後に新しいキーをコピーしてください。',
        rotated: 'ライセンスキーを更新しました',
        rotatedDescription:
          '以前のキーはもう認証されません。下の新しいキーをコピーしてください。',
        rotateFailed: 'ライセンスキーの更新に失敗しました',
      },
      slackSharedChannel: {
