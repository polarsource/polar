export default {
  "checkout": {
    "footer": {
      ...
      "merchantOfRecord": "Este pedido é processado pela Polar, nossa parceira de vendas online, responsável pela cobrança, suporte ao pedido e devoluções.",
      "mandateSubscriptionTrial": "Ao clicar em \"{buttonLabel}\", você autoriza a Polar Software, Inc., nossa parceira de vendas online, a cobrar em sua forma de pagamento selecionada o valor exibido acima ao final do seu período de teste e em cada data de cobrança subsequente até que você cancele. Você pode cancelar a qualquer momento antes do final do teste para evitar a cobrança.",
      "mandateSubscription": "Ao clicar em \"{buttonLabel}\", você autoriza a Polar Software, Inc., nossa parceira de vendas online, a cobrar imediatamente em sua forma de pagamento selecionada o valor exibido acima e a cobrar o mesmo valor em cada data de cobrança subsequente até que você cancele.",
      "mandateOneTime": "Ao clicar em \"{buttonLabel}\", você autoriza a Polar Software, Inc., nossa parceira de vendas online, a cobrar em sua forma de pagamento selecionada o valor exibido acima. Esta é uma cobrança única.",
      "buyerTermsAgreement": "Você também concorda com os",
      "buyerTermsLink": "Termos do Comprador"
    },
    "form": {
      "email": "E-mail",
    ...
    "benefits": {
      ...
      "licenseKey": {
        ...
        "copiedToClipboardDescription": "A chave de licença foi copiada para a área de transferência",
        "loading": "Carregando...",
        "status": "Status",
    ...
    "loading": {
      ...
      "confirmationTokenFailed": "Falha ao criar token de confirmação, tente novamente mais tarde."
    },
    "cta": {
