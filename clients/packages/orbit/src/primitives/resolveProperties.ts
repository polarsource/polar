...
const SPACING_BP: Record<string, Record<string, SpacingClasses>> = {
  sm: {
    ...
    'spacing-1.5': { padding: 'sm:p-3',  paddingX: 'sm:px-3',  paddingY: 'sm:py-3',  paddingTop: 'sm:pt-3',  paddingRight: 'sm:pr-3',  paddingBottom: 'sm:pb-3',  paddingLeft: 'sm:pl-3',  margin: 'sm:m-3',  marginX: 'sm:mx-3',  marginY: 'sm:my-3',  marginTop: 'sm:mt-3',  marginRight: 'sm:mr-3',  marginBottom: 'sm:mb-3',  marginLeft: 'sm:ml-3',  gap: 'sm:gap-3',  rowGap: 'sm:gap-y-3',  columnGap: 'sm:gap-x-3' },
  ...
  md: {
    ...
    'spacing-1.5': { padding: 'md:p-3',  paddingX: 'md:px-3',  paddingY: 'md:py-3',  paddingTop: 'md:pt-3',  paddingRight: 'md:pr-3',  paddingBottom: 'md:pb-3',  paddingLeft: 'md:pl-3',  margin: 'md:m-3',  marginX: 'md:mx-3',  marginY: 'md:my-3',  marginTop: 'md:mt-3',  marginRight: 'md:mr-3',  marginBottom: 'md:mb-3',  marginLeft: 'md:ml-3',  gap: 'md:gap-3',  rowGap: 'md:gap-y-3',  columnGap: 'md:gap-x-3' },
  ...
  lg: {
    ...
    'spacing-1.5': { padding: 'lg:p-3',  paddingX: 'lg:px-3',  paddingY: 'lg:py-3',  paddingTop: 'lg:pt-3',  paddingRight: 'lg:pr-3',  paddingBottom: 'lg:pb-3',  paddingLeft: 'lg:pl-3',  margin: 'lg:m-3',  marginX: 'lg:mx-3',  marginY: 'lg:my-3',  marginTop: 'lg:mt-3',  marginRight: 'lg:mr-3',  marginBottom: 'lg:mb-3',  marginLeft: 'lg:ml-3',  gap: 'lg:gap-3',  rowGap: 'lg:gap-y-3',  columnGap: 'lg:gap-x-3' },
  ...
  xl: {
    ...
    'spacing-1.5': { padding: 'xl:p-3',  paddingX: 'xl:px-3',  paddingY: 'xl:py-3',  paddingTop: 'xl:pt-3',  paddingRight: 'xl:pr-3',  paddingBottom: 'xl:pb-3',  paddingLeft: 'xl:pl-3',  margin: 'xl:m-3',  marginX: 'xl:mx-3',  marginY: 'xl:my-3',  marginTop: 'xl:mt-3',  marginRight: 'xl:mr-3',  marginBottom: 'xl:mb-3',  marginLeft: 'xl:ml-3',  gap: 'xl:gap-3',  rowGap: 'xl:gap-y-3',  columnGap: 'xl:gap-x-3' },
  ...
  '2xl': {
    ...
    'spacing-1.5': { padding: '2xl:p-3',  paddingX: '2xl:px-3',  paddingY: '2xl:py-3',  paddingTop: '2xl:pt-3',  paddingRight: '2xl:pr-3',  paddingBottom: '2xl:pb-3',  paddingLeft: '2xl:pl-3',  margin: '2xl:m-3',  marginX: '2xl:mx-3',  marginY: '2xl:my-3',  marginTop: '2xl:mt-3',  marginRight: '2xl:mr-3',  marginBottom: '2xl:mb-3',  marginLeft: '2xl:ml-3',  gap: '2xl:gap-3',  rowGap: '2xl:gap-y-3',  columnGap: '2xl:gap-x-3' },
