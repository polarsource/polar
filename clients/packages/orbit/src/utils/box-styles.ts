...
export const backgroundColorStyles = stylex.create({
  ...
  'background-opaque': { backgroundColor: colors['background-opaque'] },
...
export const colorStyles = stylex.create({
  ...
  'background-opaque': { color: colors['background-opaque'] },
...
export const borderColorStyles = stylex.create({
  ...
  'background-opaque': { borderColor: colors['background-opaque'] },
