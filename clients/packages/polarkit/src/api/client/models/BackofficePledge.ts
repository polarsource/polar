...
/**
 * Check if a given object implements the BackofficePledge interface.
 */
export function instanceOfBackofficePledge(value: object): boolean {
    let isInstance = true;
...
export function BackofficePledgeFromJSON(json: any): BackofficePledge {
    return BackofficePledgeFromJSONTyped(json, false);
}

export function BackofficePledgeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BackofficePledge {
    ...
    return {
        ...
        'dispute_reason': !exists(json, 'dispute_reason') ? undefined : json['dispute_reason'],
        'disputed_by_user_id': !exists(json, 'disputed_by_user_id') ? undefined : json['disputed_by_user_id'],
        'disputed_at': !exists(json, 'disputed_at') ? undefined : (new Date(json['disputed_at'])),
        'pledger_email': !exists(json, 'pledger_email') ? undefined : json['pledger_email'],
    };
}

export function BackofficePledgeToJSON(value?: BackofficePledge | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'disputed_at': value.disputed_at === undefined ? undefined : (value.disputed_at.toISOString()),
