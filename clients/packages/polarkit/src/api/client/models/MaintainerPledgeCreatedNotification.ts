...
/**
 * Check if a given object implements the MaintainerPledgeCreatedNotification interface.
 */
export function instanceOfMaintainerPledgeCreatedNotification(value: object): boolean {
    let isInstance = true;
...
export function MaintainerPledgeCreatedNotificationFromJSON(json: any): MaintainerPledgeCreatedNotification {
    return MaintainerPledgeCreatedNotificationFromJSONTyped(json, false);
}

export function MaintainerPledgeCreatedNotificationFromJSONTyped(json: any, ignoreDiscriminator: boolean): MaintainerPledgeCreatedNotification {
...
export function MaintainerPledgeCreatedNotificationToJSON(value?: MaintainerPledgeCreatedNotification | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
