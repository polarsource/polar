...
/**
 * Check if a given object implements the MaintainerPledgePendingNotification interface.
 */
export function instanceOfMaintainerPledgePendingNotification(value: object): boolean {
    let isInstance = true;
...
export function MaintainerPledgePendingNotificationFromJSON(json: any): MaintainerPledgePendingNotification {
    return MaintainerPledgePendingNotificationFromJSONTyped(json, false);
}

export function MaintainerPledgePendingNotificationFromJSONTyped(json: any, ignoreDiscriminator: boolean): MaintainerPledgePendingNotification {
...
export function MaintainerPledgePendingNotificationToJSON(value?: MaintainerPledgePendingNotification | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
