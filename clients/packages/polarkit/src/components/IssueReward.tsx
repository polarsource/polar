    ...
    return (
        <div className="flex items-center justify-between ">
            <div className="flex gap-2 items-center">
                ...
                <span className="text-gray-500 text-sm">contributed by <span className="text-purple-500 border-2 border-pink-800">Google</span></span>
            </div>
            <a href="#" className="text-gray-500 text-sm border-2 border-pink-800">Reward Details &rsaquo;</a>
        </div>
    )
}
