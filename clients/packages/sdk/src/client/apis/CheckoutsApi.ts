...
export class CheckoutsApi extends runtime.BaseAPI {
     ...
     */
    async clientConfirmRaw(requestParameters: CheckoutsApiClientConfirmRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CheckoutPublic>> {
     ...
     * Confirm Checkout Session from Client
     */
    async clientConfirm(requestParameters: CheckoutsApiClientConfirmRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CheckoutPublic> {
