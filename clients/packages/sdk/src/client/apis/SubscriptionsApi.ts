...
export class SubscriptionsApi extends runtime.BaseAPI {
   ...
   */
  async archiveSubscriptionTierRaw(
    requestParameters: SubscriptionsApiArchiveSubscriptionTierRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SubscriptionTier>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling archiveSubscriptionTier.',
      )
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/subscriptions/tiers/{id}/archive`.replace(
          `{${'id'}}`,
   ...
   * Archive Subscription Tier
   */
  async archiveSubscriptionTier(
    requestParameters: SubscriptionsApiArchiveSubscriptionTierRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<SubscriptionTier> {
    const response = await this.archiveSubscriptionTierRaw(
      requestParameters,
      initOverrides,
    )
   ...
   */
  async createSubscribeSessionRaw(
    requestParameters: SubscriptionsApiCreateSubscribeSessionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SubscribeSession>> {
    if (
      requestParameters.subscribeSessionCreate === null ||
      requestParameters.subscribeSessionCreate === undefined
    ) {
      throw new runtime.RequiredError(
        'subscribeSessionCreate',
        'Required parameter requestParameters.subscribeSessionCreate was null or undefined when calling createSubscribeSession.',
      )
    }
  ...
  async createSubscribeSession(
    ...
    const response = await this.createSubscribeSessionRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
   ...
   */
  async createSubscriptionBenefitRaw(
    requestParameters: SubscriptionsApiCreateSubscriptionBenefitRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<ResponseSubscriptionsCreateSubscriptionBenefit>
  > {
    if (
      requestParameters.subscriptionBenefitCreate === null ||
      requestParameters.subscriptionBenefitCreate === undefined
    ) {
      throw new runtime.RequiredError(
        'subscriptionBenefitCreate',
        'Required parameter requestParameters.subscriptionBenefitCreate was null or undefined when calling createSubscriptionBenefit.',
      )
    }
   ...
   * Create Subscription Benefit
   */
  async createSubscriptionBenefit(
    requestParameters: SubscriptionsApiCreateSubscriptionBenefitRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponseSubscriptionsCreateSubscriptionBenefit> {
    const response = await this.createSubscriptionBenefitRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
   ...
   */
  async createSubscriptionTierRaw(
    requestParameters: SubscriptionsApiCreateSubscriptionTierRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SubscriptionTier>> {
    if (
      requestParameters.subscriptionTierCreate === null ||
      requestParameters.subscriptionTierCreate === undefined
    ) {
      throw new runtime.RequiredError(
        'subscriptionTierCreate',
        'Required parameter requestParameters.subscriptionTierCreate was null or undefined when calling createSubscriptionTier.',
      )
    }
  ...
  async createSubscriptionTier(
    ...
    const response = await this.createSubscriptionTierRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
   ...
   */
  async deleteSubscriptionBenefitRaw(
    requestParameters: SubscriptionsApiDeleteSubscriptionBenefitRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling deleteSubscriptionBenefit.',
      )
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/subscriptions/benefits/{id}`.replace(
          `{${'id'}}`,
          encodeURIComponent(String(requestParameters.id)),
        ),
        method: 'DELETE',
   ...
   * Delete Subscription Benefit
   */
  async deleteSubscriptionBenefit(
    requestParameters: SubscriptionsApiDeleteSubscriptionBenefitRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
  ...
  async getSubscribeSessionRaw(
    ...
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling getSubscribeSession.',
      )
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/subscriptions/subscribe-sessions/{id}`.replace(
          `{${'id'}}`,
          encodeURIComponent(String(requestParameters.id)),
        ),
        method: 'GET',
  ...
  async getSubscriptionsStatisticsRaw(
    ...
    if (requestParameters.subscriptionTierId !== undefined) {
      queryParameters['subscription_tier_id'] =
        requestParameters.subscriptionTierId
    }
   ...
   */
  async lookupSubscriptionBenefit(
    requestParameters: SubscriptionsApiLookupSubscriptionBenefitRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponseSubscriptionsLookupSubscriptionBenefit> {
    const response = await this.lookupSubscriptionBenefitRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
   ...
   */
  async lookupSubscriptionTierRaw(
    requestParameters: SubscriptionsApiLookupSubscriptionTierRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SubscriptionTier>> {
    if (
      requestParameters.subscriptionTierId === null ||
      requestParameters.subscriptionTierId === undefined
    ) {
      throw new runtime.RequiredError(
        'subscriptionTierId',
        'Required parameter requestParameters.subscriptionTierId was null or undefined when calling lookupSubscriptionTier.',
      )
    }
   ...
   * Lookup Subscription Tier
   */
  async lookupSubscriptionTier(
    requestParameters: SubscriptionsApiLookupSubscriptionTierRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<SubscriptionTier> {
    const response = await this.lookupSubscriptionTierRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
   ...
   */
  async searchSubscriptionBenefitsRaw(
    requestParameters: SubscriptionsApiSearchSubscriptionBenefitsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<ListResourceUnionSubscriptionBenefitBuiltinSubscriptionBenefitCustom>
  > {
    if (
      requestParameters.organizationName === null ||
      requestParameters.organizationName === undefined
      ...
      throw new runtime.RequiredError(
        'organizationName',
        'Required parameter requestParameters.organizationName was null or undefined when calling searchSubscriptionBenefits.',
      )
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'platform',
        'Required parameter requestParameters.platform was null or undefined when calling searchSubscriptionBenefits.',
      )
    }
  ...
  async searchSubscriptionBenefits(
    requestParameters: SubscriptionsApiSearchSubscriptionBenefitsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ListResourceUnionSubscriptionBenefitBuiltinSubscriptionBenefitCustom> {
    const response = await this.searchSubscriptionBenefitsRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
   ...
   */
  async searchSubscriptionTiersRaw(
    requestParameters: SubscriptionsApiSearchSubscriptionTiersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ListResourceSubscriptionTier>> {
    if (
      requestParameters.organizationName === null ||
      requestParameters.organizationName === undefined
    ) {
      throw new runtime.RequiredError(
        'organizationName',
        'Required parameter requestParameters.organizationName was null or undefined when calling searchSubscriptionTiers.',
      )
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'platform',
        'Required parameter requestParameters.platform was null or undefined when calling searchSubscriptionTiers.',
      )
    }
   ...
   * Search Subscription Tiers
   */
  async searchSubscriptionTiers(
    requestParameters: SubscriptionsApiSearchSubscriptionTiersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ListResourceSubscriptionTier> {
    const response = await this.searchSubscriptionTiersRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
   ...
   */
  async searchSubscriptionsRaw(
    requestParameters: SubscriptionsApiSearchSubscriptionsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ListResourceSubscription>> {
    const queryParameters: any = {}
  ...
  async searchSubscriptions(
    ...
    const response = await this.searchSubscriptionsRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
  ...
  > {
    ...
    if (
      requestParameters.subscriptionBenefitUpdate === null ||
      requestParameters.subscriptionBenefitUpdate === undefined
    ) {
      throw new runtime.RequiredError(
        'subscriptionBenefitUpdate',
        'Required parameter requestParameters.subscriptionBenefitUpdate was null or undefined when calling updateSubscriptionBenefit.',
      )
    }
   ...
   * Update Subscription Benefit
   */
  async updateSubscriptionBenefit(
    requestParameters: SubscriptionsApiUpdateSubscriptionBenefitRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponseSubscriptionsUpdateSubscriptionBenefit> {
    const response = await this.updateSubscriptionBenefitRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
  ...
  > {
    ...
    if (
      requestParameters.subscriptionTierUpdate === null ||
      requestParameters.subscriptionTierUpdate === undefined
    ) {
      throw new runtime.RequiredError(
        'subscriptionTierUpdate',
        'Required parameter requestParameters.subscriptionTierUpdate was null or undefined when calling updateSubscriptionTier.',
      )
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/subscriptions/tiers/{id}`.replace(
          `{${'id'}}`,
          encodeURIComponent(String(requestParameters.id)),
        ),
        method: 'POST',
  ...
  async updateSubscriptionTier(
    ...
    const response = await this.updateSubscriptionTierRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
   ...
   */
  async updateSubscriptionTierBenefitsRaw(
    requestParameters: SubscriptionsApiUpdateSubscriptionTierBenefitsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SubscriptionTier>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling updateSubscriptionTierBenefits.',
      )
    }

    if (
      requestParameters.subscriptionTierBenefitsUpdate === null ||
      requestParameters.subscriptionTierBenefitsUpdate === undefined
    ) {
      throw new runtime.RequiredError(
        'subscriptionTierBenefitsUpdate',
        'Required parameter requestParameters.subscriptionTierBenefitsUpdate was null or undefined when calling updateSubscriptionTierBenefits.',
      )
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/subscriptions/tiers/{id}/benefits`.replace(
          `{${'id'}}`,
          encodeURIComponent(String(requestParameters.id)),
        ),
        method: 'POST',
   ...
   * Update Subscription Tier Benefits
   */
  async updateSubscriptionTierBenefits(
    requestParameters: SubscriptionsApiUpdateSubscriptionTierBenefitsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<SubscriptionTier> {
    const response = await this.updateSubscriptionTierBenefitsRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
