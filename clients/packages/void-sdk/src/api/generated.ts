...
export type SenseOverWindow = { readonly "type": "window", readonly "amount": number, readonly "unit": "minute" | "hour" | "day" }
export const SenseOverWindow = Schema.Struct({ "type": Schema.Literal("window"), "amount": Schema.Number.check(Schema.isInt()).check(Schema.isGreaterThanOrEqualTo(1)), "unit": Schema.Literals(["minute", "hour", "day"]) }).annotate({ "title": "SenseOverWindow", "identifier": "SenseOverWindow" })
export type SenseOverRun = { readonly "type": "run" }
export const SenseOverRun = Schema.Struct({ "type": Schema.Literal("run") }).annotate({ "title": "SenseOverRun", "identifier": "SenseOverRun" })
export type SenseOver = SenseOverWindow | SenseOverRun
export const SenseOver = Schema.Union([SenseOverWindow, SenseOverRun])
export type DeploySense = { readonly "slug": string, readonly "activity": string, readonly "when": string, readonly "over": SenseOver }
export const DeploySense = Schema.Struct({ "slug": Schema.String.check(Schema.isMinLength(1)).check(Schema.isPattern(new RegExp("^[a-z0-9][a-z0-9_-]*$"))), "activity": Schema.String.check(Schema.isMinLength(1)).check(Schema.isPattern(new RegExp("^[a-z0-9][a-z0-9_-]*$"))), "when": Schema.String.check(Schema.isMinLength(1)).check(Schema.isMaxLength(512)), "over": SenseOver }).annotate({ "title": "DeploySense", "identifier": "DeploySense" })
export type CustomerSenseState = { readonly "slug": string, readonly "activity": string, readonly "when": string, readonly "over": SenseOver, readonly "identity_id": string, readonly "run_key": string | null, readonly "noul": number, readonly "span_count": number, readonly "cost": number | null, readonly "evaluated_at": string }
export const CustomerSenseState = Schema.Struct({ "slug": Schema.String, "activity": Schema.String, "when": Schema.String, "over": SenseOver, "identity_id": Schema.String, "run_key": Schema.Union([Schema.String, Schema.Null]), "noul": Schema.Number, "span_count": Schema.Number, "cost": Schema.Union([Schema.Number, Schema.Null]), "evaluated_at": Schema.String.annotate({ "format": "date-time" }) }).annotate({ "title": "CustomerSenseState", "identifier": "CustomerSenseState" })
...
export type IdentitySnapshot = { readonly "at": string, readonly "identity": Identity, readonly "root": Identity, readonly "customer": Customer | null, readonly "meters": { readonly [x: string]: Balance }, readonly "entitlements": ReadonlyArray<string>, readonly "senses"?: ReadonlyArray<CustomerSenseState> }
export const IdentitySnapshot = Schema.Struct({ "at": Schema.String.annotate({ "title": "At", "examples": ["2026-01-01T00:00:00.000000Z"], "format": "date-time" }), "identity": Identity, "root": Identity, "customer": Schema.Union([Customer, Schema.Null]), "meters": Schema.Record(Schema.String, Balance).annotate({ "title": "Meters", "description": "Current mainline meter balances, keyed by meter slug." }), "entitlements": Schema.Array(Schema.String).annotate({ "title": "Entitlements", "description": "Entitlement slugs held through this identity's chain." }), "senses": Schema.optionalKey(Schema.Array(CustomerSenseState).annotate({ "title": "Senses", "default": [] })) }).annotate({ "title": "IdentitySnapshot", "identifier": "IdentitySnapshot" })
