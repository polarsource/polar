...
description: "Base URLs, authentication (OAT), and the difference between the Core API and the Customer Portal API"
---
...
- **100 requests per second** per organization/customer or OAuth2 Client.
