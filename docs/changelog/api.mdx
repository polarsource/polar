...
* Added [`subscription.migrated`](/api-reference/current/subscription_migrated) webhook, sent when Polar takes over billing of a subscription imported from another provider.
