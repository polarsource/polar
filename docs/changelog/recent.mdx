...
<img src="/assets/changelog/2025-10-01/cancellation-metrics-example.jpeg" />
...
Resolved a bug where selecting dates in the date picker could cause an infinite rendering loop, improving reliability for date-related forms.
  ...
  ## Require opt-in if you will be charged immediately TODO

We now require explicit opt-in from customers before an immediate charge is processed, increasing transparency and reducing surprise payments.
