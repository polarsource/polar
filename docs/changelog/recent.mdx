...
<Update label="2025-09-22">
  ## Improve preview of next invoice in Customer Portal

We've enhanced the Customer Portal to provide a clearer and more accurate preview of your next invoice. The overview now updates automatically after subscription changes, and you can preview upcoming charges with all relevant taxes included.

([#6908](https://github.com/polarsource/polar/pull/6908), [#6867](https://github.com/polarsource/polar/pull/6867)) — by [pieterbeulque](https://github.com/pieterbeulque)
...
([#6900](https://github.com/polarsource/polar/pull/6900)) — by [pieterbeulque](https://github.com/pieterbeulque)
