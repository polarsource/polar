...
<img className="block dark:hidden" src="/assets/features/orders/checkout.light.png" />
<img className="hidden dark:block" src="/assets/features/orders/checkout.dark.png" />
