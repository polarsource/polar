...
**For faster review processing, please ensure:**

- **Social media presence**: Add at least one social media account to your organization settings. Make sure these are personal social accounts (not company accounts) for verification purposes.
- **Working website**: Ensure your website is accessible and returns a proper response (we verify this with automated checks).
- **Complete KYC**: Finish your identity verification (KYC) process in the Polar dashboard before requesting a review.
