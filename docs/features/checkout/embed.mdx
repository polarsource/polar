...
<Note>
  Add every host in one go, staging and preview domains included — paste them separated by commas or new lines. The list takes effect as soon as you save it, so a host you leave out stops working straight away.
</Note>
