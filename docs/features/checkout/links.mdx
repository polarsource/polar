...
<Frame>
  <img
    ...
    src="/assets/features/checkout/links/create.light.png"
  />
  <img
    className="hidden dark:block"
    src="/assets/features/checkout/links/create.dark.png"
  />
</Frame>
...
<img
  className="block dark:hidden"
  src="/assets/features/checkout/links/checkout_multiple_products.light.png"
/>
<img
  className="hidden dark:block"
  src="/assets/features/checkout/links/checkout_multiple_products.dark.png"
/>
...
<img
  className="block dark:hidden"
  src="/assets/features/checkout/links/checkout_link.light.png"
/>
<img
  className="hidden dark:block"
  src="/assets/features/checkout/links/checkout_link.dark.png"
/>
