...
Under the hood, this calls the [Create Customer Session](/api-reference/customer-sessions/create-customer-session) endpoint and redirects the user to the `customerPortalUrl` it returns.
