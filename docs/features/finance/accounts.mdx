...
You need to connect a payout account **before Polar can accept money on your behalf**. We don't want to collect funds from your customers that we wouldn't be able to pay out to you, so a working payout account is a prerequisite to going live — not just to issuing your first [payout](/features/finance/payouts).
