...
You can generate them from the **Payouts** page under **Finance** in your Polar dashboard. Click on the ellipsis next to the payout you want to generate a reverse invoice for, and select **Generate Reverse Invoice**.
...
- Set tour billing name and address
