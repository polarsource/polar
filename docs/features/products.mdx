...
You can read more about how trials work [here](/features/subscriptions/trials).

### Description

Optional text that appears on the checkout page so you can describe your product and how it is presented during checkout. Content supports **Markdown** formatting.
