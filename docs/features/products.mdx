...
A product without an order, subscription, trial or discount can be permanently deleted. Archive it first, then click **Delete Permanently** from the product menu. The option only appears for products that aren't in use.
