...
<Tip>
Selling a quantity that isn't a person, such as devices or storage? Use [unit-based pricing](/features/unit-based-pricing) instead. It skips seat assignment and grants benefits once to the customer.
</Tip>
