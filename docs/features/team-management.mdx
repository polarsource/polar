...
| **Finance** | Manages sales and can view financial, customer, product, custom-field, and analytics data without changing organization settings or payouts. |
...
| Permission | Member | Finance | Admin | Owner |
| --- | :---: | :---: | :---: | :---: |
| View products, customers, custom fields & analytics | ✓ | ✓ | ✓ | ✓ |
| Manage products, customers, custom fields & analytics | ✓ | | ✓ | ✓ |
| View & manage sales (orders, subscriptions, refunds) | ✓ | ✓ | ✓ | ✓ |
| View other members | ✓ | | ✓ | ✓ |
| Invite, remove & change member roles | | | ✓ | ✓ |
| View finances (balance, transactions, payout history) | | ✓ | ✓ | ✓ |
| Manage finances and payouts | | | ✓ | ✓ |
...
4. Select **Admin**, **Finance**, or **Member** and click **Save**.
