...
- `Average` - Finds the average value of a property.
- `Minimum` - Finds the minimum value of a property.
- `Maximum` - Finds the maximum value of a property.
