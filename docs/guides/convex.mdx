---
title: "Integrate Polar with Convex"
sidebarTitle: "Convex"
description: "In this guide, we'll show you how to integrate Polar with Convex."
---

## Examples

- [With Convex](https://github.com/polarsource/examples/tree/main/with-convex)
...
## Install the Polar TypeScript SDK

To get started, you need to install the Polar TypeScript SDK. You can do this by running the following command:
...
To authenticate with Polar, you need to create an access token, and supply it to Convex using a `POLAR_ACCESS_TOKEN` environment variable.

You can create an organization access token from your organization settings.

```bash Terminal
npx convex set POLAR_ACCESS_TOKEN "val"
```
