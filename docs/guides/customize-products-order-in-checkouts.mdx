...
<Steps>
    ...
    <Step title="Open the Checkout Link URL">
        ...
        ```
        It looks like below:
        <img height="200" src="/assets/guides/customize-products-order-in-checkouts/Product1-Product2.png" />
    </Step>  
    <Step title = "Change the order of products">
        ...
        <img height="200" src="/assets/guides/customize-products-order-in-checkouts/Product2-Product1.png" />
    </Step>
</Steps>
