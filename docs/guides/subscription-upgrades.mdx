...
<Info>
    Note that merchants can disable customer-level upgrades or downgrades in the portal by toggling OFF the [**Enable subscription plan changes**](/features/customer-portal/settings#enable-subscription-plan-changes) setting. 
</Info>
