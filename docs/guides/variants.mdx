...
### I : Creation of product variants (3 subscription products)
<Steps>
...
### III: How to downgrade the product variant
<Steps>
...
### III: How to ugrade the product variant
<Steps>
    <Step title = "Open Customer Portal and click on Change Plan">
        On opening the link from the email received, the customer needs to click on **Change Plan**.
        <img height="200" src="/assets/guides/variants/customer-portal-1.png" />
