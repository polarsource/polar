            ...
            polar({ // [!code ++]
                ...
                use: [ // [!code ++]
                    checkout({ // [!code ++]
                        ...
                        successUrl: "https://your-app.com/success?checkout_id={CHECKOUT_ID}", // [!code ++]
...
- **`successUrl`** (optional): The absolute URL where customers will be redirected after a successful checkout completion. You can use the `{CHECKOUT_ID}` placeholder in the URL to include the checkout session ID in the redirect.
            ...
            polar({
                ...
                use: [
                    checkout({ // [!code ++]
                        ...
                        // Absolute URL to return to when checkout is successfully completed
                        successUrl: "https://your-app.com/success?checkout_id={CHECKOUT_ID}", // [!code ++]
