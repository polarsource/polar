...
<Tip>
  **Developing locally?**
  ...
  The [Polar CLI](/cli/webhooks) forwards your organization's webhooks to a URL on your machine, so you can test handlers without deploying them.
  ...
  It also sends sample events on demand with `polar trigger`.
</Tip>
