...
<Columns cols={2}>
  ...
  <Card
    ...
    icon="link"
    href="/api-reference/current/subscription_imported"
    horizontal
  >
    Fired when Polar takes over billing of a subscription imported from another platform. Includes `platform` and `external_id`.
  </Card>
