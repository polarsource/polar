...
<Columns cols={2}>
  ...
  <Card
    ...
    icon="link"
    href="/api-reference/subscriptioncycled"
    horizontal
  >
    Fired when a subscription enters a new billing period, before the renewal order exists.
  </Card>
  ...
  >
    ...
    To act on a renewal, listen to `subscription.cycled` instead — it fires
    whether or not the renewal payment succeeds.
  </Card>
...
<Columns cols={2}>
  <Card
    ...
    icon="link"
    href="/api-reference/discountcreated"
    horizontal
  ></Card>
  <Card
    title="discount.updated"
    icon="link"
    href="/api-reference/discountupdated"
    horizontal
  ></Card>
  <Card
    title="discount.deleted"
    icon="link"
    href="/api-reference/discountdeleted"
    horizontal
  ></Card>
</Columns>
