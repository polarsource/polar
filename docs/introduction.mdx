...
<CardGroup cols={2}>
  <Card title="5% + 50¢" icon="percent">
    **Per successful transaction (Starter plan)**

    Simple, transparent pricing with no surprises

  </Card>
  <Card title="$0" icon="dollar-sign">
    **Monthly fee on the free Starter plan**

    Optional paid plans lower your per-transaction rate
