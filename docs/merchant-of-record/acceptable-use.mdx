...
* Open Source Intelligence (OSINT) platforms: Services that aggregate, search, or expose personal data about individuals using public or leaked sources. This includes people-finding tools, background check services, and identity profiling platforms, regardless of their stated purpose.
