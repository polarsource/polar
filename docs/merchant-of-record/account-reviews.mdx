...
While a review is in progress, [payouts](/features/finance/payouts) are temporarily paused — so you may notice that you can't withdraw your balance until the review is resolved. This has no impact on your customers, who can keep purchasing, subscribing, and checking out as usual.
