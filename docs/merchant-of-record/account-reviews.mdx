...
We aim to work with you on the best path forward, but for compliance and risk reasons we have to cancel subscriptions and refund payments made in violation of the policy. Subscriptions are automatically cancelled after a 7-day window.
