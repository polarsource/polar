...
We may request a video recording showing the product working to check the automated fulfillment of things as per [acceptable use](/merchant-of-record/acceptable-use).
...
4. Send an email from the current admin email confirming the transfer to the said new admin
