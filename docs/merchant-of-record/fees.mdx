...
However, we continuously work to proactively reduce the rate of chargebacks across Polar to be at or lower than industry standards. We integrate with credit card networks to receive early chargeback signals before they're officially filed. When we receive one of these alerts, we may proactively refund the payment and cancel any related subscription to prevent a formal chargeback. These chargeback prevention alerts cost $25 per alert, which is deducted from your balance.
