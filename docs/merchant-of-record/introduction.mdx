...
2. Polar with a ~2.1% premium vs. Stripe would need to help facilitate ~\$57,143 in sales for the given market in order for it to cover our accounting costs (\$1,200/2.1%)
