...
Use the [migration assistant prompt](/migrate/ai-assistant) with a coding
assistant that can inspect your application. It produces an identity map,
endpoint and webhook plan, reconciliation model, and phased implementation
proposal before changing code.

<Card
  title="Open the migration assistant prompt"
  icon="wand-magic-sparkles"
  href="/migrate/ai-assistant"
  horizontal
>
  Copy a grounded prompt for planning your Stripe and Polar coexistence.
</Card>
