...
<AccordionGroup>
  ...
  <Accordion title="Saved card transfer">
    ...
    Stripe Connect platform accounts and Stripe accounts in India cannot connect
    to the automated migration flow. [Contact Polar support](/support) to discuss
    a different migration path.
  </Accordion>
