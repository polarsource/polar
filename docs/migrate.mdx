...
description: "Move new sales and existing Stripe subscriptions to Polar in controlled phases."
---

You do not need to move your entire billing system at once. A migration from
Stripe can run in phases: send new business through Polar first, prepare your
existing billing in the background, and switch subscriptions only when they are
ready.
