...
<Accordion
  title="Copy the migration assistant prompt"
  icon="wand-magic-sparkles"
>
  Review the assistant's proposed identity map and cutover gates before asking
  it to implement anything. Never paste Stripe or Polar secrets into a
  conversation.

  <div className="max-h-[32rem] overflow-y-auto overscroll-contain rounded-xl border border-gray-200 dark:border-gray-800">
