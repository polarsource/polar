...
Stripe and Polar events can arrive in either order. Do not treat the Stripe
cancellation as ordinary churn or revoke access while its matching migration
