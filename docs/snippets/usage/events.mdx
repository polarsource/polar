...
Events are sent to Polar using the [Events Ingestion API](/api-reference/events/ingest-events) and are stored in our database. An event consists of the following fields:
