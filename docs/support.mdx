...
Merchant account reviews are typically done within 7 days, but can take up to 14 days

More information on Account Reviews and the process can be found in our [Account Review Documentation](https://polar.sh/docs/merchant-of-record/account-reviews)
