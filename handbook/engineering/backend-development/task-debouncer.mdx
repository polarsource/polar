...
**Limitation:** Debounced tasks cannot be routed to SQS/Lambda workers. They must run on the Dramatiq/Redis broker. The system validates this at startup and will raise an error if a debounced actor is added to the SQS allowlist.
