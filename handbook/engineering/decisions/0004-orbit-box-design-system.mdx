...
- Custom Oxlint rules enforce it: `no-classname-box`, `no-style-box`, `no-classname-text` on
...
- Enforcement: `clients/apps/web/oxlint-plugins/`, `clients/apps/app/oxlint-plugins/`.
