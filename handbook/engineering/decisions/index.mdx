...
- [ADR-0010: Void deployments are hash-versioned and linear](/engineering/decisions/0010-void-deployments-are-hash-versioned-and-linear) · Cross-cutting · Accepted
- [ADR-0011: Void branches fork a version and never serve traffic](/engineering/decisions/0011-void-branches-fork-versions-and-never-serve) · Cross-cutting · Accepted
