...
- [ADR-0010: Signals are part of the deployed configuration](/engineering/decisions/0010-persist-signals-in-the-deployment) · Backend · Accepted
- [ADR-0011: Activity definitions live in the deployment; spans queue themselves](/engineering/decisions/0011-activity-spans-queue-themselves) · Backend · Accepted
