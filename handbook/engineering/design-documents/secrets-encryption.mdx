...
| Model | Column | File | Encrypted column | Status |
|---|---|---|---|---|
| `OAuthAccount` | `access_token`, `refresh_token` | `server/polar/models/user.py:68` | `access_token_encrypted`, `refresh_token_encrypted` | Dual-write + backfill |
| `SlackApp` | `client_secret`, `signing_secret`, `bot_token` | `server/polar/models/slack_app.py:30` | `client_secret_encrypted`, `signing_secret_encrypted`, `bot_token_encrypted` | Dual-write |
| `OAuth2Client` | `client_secret`, `registration_access_token` | `server/polar/models/oauth2_client.py:20` | — | Not started |
...
| Step | Columns | Why first | Status |
|---|---|---|---|
| 1 | `OAuthAccount.access_token`, `refresh_token` | Account takeover; one per user | Dual-write + backfill |
| 2 | `SlackApp.client_secret`, `signing_secret`, `bot_token` | Workspace takeover | Dual-write |
| 3 | `OAuth2Client.client_secret`, `registration_access_token` | Low cardinality, lower urgency | Not started |
