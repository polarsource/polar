...
Polar Cycle is the small Slack bot that posts PR threads in `#engineering` and picks a primary reviewer whenever a team is requested for review. It runs on Vercel at [polar-cycle.vercel.app](https://polar-cycle.vercel.app), with a tiny admin UI for the bits we need to tweak day to day.
