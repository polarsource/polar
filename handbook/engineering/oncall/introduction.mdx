...
Every incident gets a severity level. Set it in the incident channel with `@incident sev 1`, `sev 2` or `sev 3`. The full definitions are in the [Polar Incident Handbook](https://docs.google.com/document/d/1JaYjZEzFexCTGfA5S6gD2yMJI-pRV5NW-hrjeR6TrWA/edit?tab=t.0#heading=h.gsihlx5bqxv) (internal).
...
- Leadership, for SEV1 and security incidents, is Birk.
