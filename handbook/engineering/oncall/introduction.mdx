...
<CardGroup cols={2}>
  ...
  <Card title="Vendor Security Monitoring" icon="shield-halved" href="/engineering/oncall/vendor-advisories">
    Security advisories from subservice organizations, and verifying they will notify us of a breach
  </Card>
</CardGroup>
