...
<CardGroup cols={2}>
  ...
  <Card title="Rotate the JWKS Signing Key" icon="file-signature" href="/engineering/oncall/rotate-jwks">
    Publish a new signing key generation and retire the old one
  </Card>

  <Card title="Rotate the Token Hashing Secret" icon="fingerprint" href="/engineering/oncall/rotate-secret">
    Add a hashing secret, let credentials migrate to it, retire the old one
  </Card>

  <Card title="Respond to a KMS Key Compromise" icon="triangle-exclamation" href="/engineering/oncall/respond-to-a-kms-compromise">
    Revoke the principal, read what was decrypted, reissue those secrets
  </Card>
