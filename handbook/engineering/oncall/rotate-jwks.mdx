...
An OAuth2 authorization-code flow, checking the `id_token`'s `kid`, and an SSO login on an
organization using **Private key JWT**.

## 6. Wait seven days

Anything the old key signed expires within the hour. The rest is margin.
