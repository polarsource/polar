// Generated from metrics:get (2026-04). Do not edit.
...
export const command = Command.make(
  ...
  (config) =>
    Effect.gen(function* () {
      ...
      const query = mergeInput<Query>(config.data, {
        ...
        billing_type: config.input.billing_type,
  ...
  Command.withDescription('Get metrics about your orders and subscriptions.'),
)
