...
{% endif %}
{% if imports.input %}
from polar.{{ version }}.inputs import (
...
{% endif %}
{% if imports.errors %}
from polar.{{ version }}.errors import (
...
{% endfor %}
{% else %}
{% for union_model in api.input_unions if union_model.name == method.body.name %}
...
Returns:
    A generator that yields items of type {{ method.pagination.item_schema | type_annotation }}.
...
Returns:
    An async generator that yields items of type {{ method.pagination.item_schema | type_annotation }}.
