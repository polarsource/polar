            ...
            },
            {
                ...
                "output_models": [
                    ...
                    },
                    {
                        ...
                        "fields": [
                            {"name": "name", "type": _STRING, "required": True},
                            {"name": "email", "type": _STRING, "required": True},
                        ],
                    },
                ],
                "enums": [],
                ...
                "input_models": [
                    {
                        "name": "UserCreate",
                        "fields": [
                            {"name": "name", "type": _STRING, "required": False},
                            {"name": "email", "type": _STRING, "required": False},
                        ],
                    },
                ],
                "output_models": [
                ...
                "output_models": [
                    {
                        "name": "SystemEvent",
                        "fields": [
                            {"name": "source", "type": _STRING, "required": True}
                        ],
                    },
                    {
                        "name": "UserEvent",
        ...
        pytest.param(
            ...
            },
            {
                ...
                "output_models": [
                    {
                        "name": "BankPayment",
                        "fields": [{"name": "iban", "type": _STRING, "required": True}],
                    },
                    {
                        "name": "CardPayment",
                        "fields": [
                ...
                "output_models": [
                    {
                        "name": "NotFound",
                        "fields": [
                            {"name": "detail", "type": _STRING, "required": False},
                        ],
                    },
                    {
                        "name": "Product",
            ...
            },
            {
                ...
                "output_models": [
                    ...
                    },
                    {
                        "name": "Mastercard",
                        "fields": [
                            {"name": "card_type", "type": _STRING, "required": True}
                        ],
                    },
                    {
                        "name": "VisaCard",
                ...
                "input_models": [
                    {
                        ...
                        "fields": [
                            {"name": "id", "type": _STRING, "required": False},
                            {"name": "file_name", "type": _STRING, "required": True},
                            {
                                "name": "file_size",
                                "type": {"kind": "primitive", "type": "integer"},
                                "required": True,
...
def test_ir_generation(
    input: dict[typing.Any, typing.Any], output: dict[typing.Any, typing.Any]
) -> None:
