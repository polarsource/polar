...
export const iterListCustomFields = (client: ClientBase) => {
  return async function* (
    ...
    while (true) {
      const response = await listCustomFields(client)({ ...query, page, limit }, requestOptions);
...
export const createCustomFields = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (body: CustomFieldCreate, requestOptions?: RequestOptions): Promise<CustomField> => {
    const pathParams = {};
    const queryParams = {};
    const request = client.buildRequest(
      "POST",
...
export const getCustomFields = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (id: string, requestOptions?: RequestOptions): Promise<CustomField> => {
    const pathParams = {
      id: id,
    };
    const queryParams = {};
