...
export const iterListCustomers = (client: ClientBase) => {
  return async function* (
    ...
    while (true) {
      const response = await listCustomers(client)({ ...query, page, limit }, requestOptions);
...
export const createCustomers = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (body: CustomerCreate, requestOptions?: RequestOptions): Promise<Customer> => {
    const pathParams = {};
    const queryParams = {};
...
export const getCustomers = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (id: string, requestOptions?: RequestOptions): Promise<Customer> => {
    const pathParams = {
      id: id,
    };
    const queryParams = {};
...
export const getExternalCustomers = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (external_id: string, requestOptions?: RequestOptions): Promise<Customer> => {
    const pathParams = {
...
export const getStateCustomers = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (id: string, requestOptions?: RequestOptions): Promise<CustomerState> => {
    const pathParams = {
      id: id,
    };
    const queryParams = {};
...
export const getStateExternalCustomers = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (external_id: string, requestOptions?: RequestOptions): Promise<CustomerState> => {
    const pathParams = {
      external_id: external_id,
    };
    const queryParams = {};
...
export const iterListPaymentMethodsExternalCustomers = (client: ClientBase) => {
  return async function* (
    ...
    while (true) {
      const response = await listPaymentMethodsExternalCustomers(client)(
        external_id,
        { ...query, page, limit },
        requestOptions,
      );
