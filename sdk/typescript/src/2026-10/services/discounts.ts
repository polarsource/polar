...
export const iterListDiscounts = (client: ClientBase) => {
  return async function* (
    ...
    while (true) {
      const response = await listDiscounts(client)({ ...query, page, limit }, requestOptions);
...
export const createDiscounts = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (body: DiscountCreate, requestOptions?: RequestOptions): Promise<Discount> => {
    const pathParams = {};
    const queryParams = {};
...
export const getDiscounts = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (id: string, requestOptions?: RequestOptions): Promise<Discount> => {
    const pathParams = {
      id: id,
    };
    const queryParams = {};
