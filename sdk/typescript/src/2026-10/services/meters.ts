...
export const iterListMeters = (client: ClientBase) => {
  return async function* (
    ...
    while (true) {
      const response = await listMeters(client)({ ...query, page, limit }, requestOptions);
...
export const createMeters = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (body: MeterCreate, requestOptions?: RequestOptions): Promise<Meter> => {
    const pathParams = {};
    const queryParams = {};
...
export const getMeters = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (id: string, requestOptions?: RequestOptions): Promise<Meter> => {
    const pathParams = {
      id: id,
    };
    const queryParams = {};
...
export const updateMeters = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (id: string, body: MeterUpdate, requestOptions?: RequestOptions): Promise<Meter> => {
    const pathParams = {
      id: id,
    };
    const queryParams = {};
