...
export const getOrders = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (id: string, requestOptions?: RequestOptions): Promise<Order> => {
    const pathParams = {
      id: id,
    };
    const queryParams = {};
...
export const updateOrders = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (id: string, body: OrderUpdate, requestOptions?: RequestOptions): Promise<Order> => {
    const pathParams = {
      id: id,
    };
    const queryParams = {};
...
export const invoiceOrders = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (id: string, requestOptions?: RequestOptions): Promise<OrderInvoice> => {
    const pathParams = {
      id: id,
    };
    const queryParams = {};
