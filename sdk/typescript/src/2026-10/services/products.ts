...
export const iterListProducts = (client: ClientBase) => {
  return async function* (
    ...
    while (true) {
      const response = await listProducts(client)({ ...query, page, limit }, requestOptions);
...
export const createProducts = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (body: ProductCreate, requestOptions?: RequestOptions): Promise<Product> => {
    const pathParams = {};
    const queryParams = {};
...
export const getProducts = (client: ClientBase) => {
   ...
   * @throws {HTTPValidationError} Validation Error
   */
  return async (id: string, requestOptions?: RequestOptions): Promise<Product> => {
    const pathParams = {
      id: id,
    };
    const queryParams = {};
