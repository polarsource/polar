  ...
  return (
    <Section className="mb-[12px] rounded-lg border border-solid border-gray-200 p-[12px]">
      <div className="mr-[32px] inline-flex items-start">
        <div className="mr-[18px] flex h-[12px] w-[12px] shrink-0 items-center justify-center rounded-full bg-black p-[5px] text-[12px] leading-none font-semibold text-white">
          <BenefitIcon benefit={benefit} width={12} height={12} />
        </div>
        <div>
          <Heading as="h2" className="mt-px mb-0 text-lg text-gray-900">
            {description}
          </Heading>
          {type === 'custom' && properties.note && (
            <div className="mt-[8px] text-sm leading-[24px] text-gray-500">
