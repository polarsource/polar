...
def upgrade() -> None:
    ...
    op.create_foreign_key(op.f('accounts_admin_id_fkey'), 'accounts', 'users', ['admin_id'], ['id'])
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('accounts', sa.Column('user_id', sa.UUID(), autoincrement=False, nullable=False))
    op.add_column('accounts', sa.Column('is_personal', sa.BOOLEAN(), autoincrement=False, nullable=False))
