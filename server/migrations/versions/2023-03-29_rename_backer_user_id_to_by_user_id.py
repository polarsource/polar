...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        op.f('pledges_by_user_id_fkey'), 'pledges', 'users', ['by_user_id'], ['id'],
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        'pledges_backer_user_id_fkey', 'pledges', 'users', ['backer_user_id'], ['id'],
    )
    op.drop_index(op.f('ix_pledges_by_user_id'), table_name='pledges')
    op.create_index(
        'ix_pledges_backer_user_id', 'pledges', ['backer_user_id'], unique=False,
    )
