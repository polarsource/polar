...
def upgrade() -> None:
    ...
    op.add_column('pledges', sa.Column('disputed_at', sa.TIMESTAMP(timezone=True), nullable=True))
    op.create_foreign_key(op.f('pledges_disputed_by_user_id_fkey'), 'pledges', 'users', ['disputed_by_user_id'], ['id'])
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(op.f('pledges_disputed_by_user_id_fkey'), 'pledges', type_='foreignkey')
