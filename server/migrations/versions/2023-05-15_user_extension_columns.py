...
def upgrade() -> None:
    op.add_column('users', sa.Column('last_seen_at_extension', sa.TIMESTAMP(timezone=True), nullable=True))
    op.add_column('users', sa.Column('last_version_extension', sa.String(length=50), nullable=True))
