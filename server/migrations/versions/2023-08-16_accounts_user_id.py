...
Revision ID: 31cc3a72ef76
Revises: 1bd979055f40
Create Date: 2023-08-16 14:19:14.301960
...
def upgrade() -> None:
    ...
    op.alter_column('accounts', 'organization_id',
    ...
    op.create_foreign_key(op.f('accounts_user_id_fkey'), 'accounts', 'organizations', ['user_id'], ['id'])
