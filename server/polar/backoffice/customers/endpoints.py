        ...
        with doc.div(classes="flex flex-col gap-4"):
                    ...
                    with doc.div(classes="card-body"):
                        ...
                        if customer.billing_address:
                            with doc.div(classes="mt-4"):
                                with doc.h3(classes="text-lg font-semibold mb-2"):
                ...
                with doc.div(classes="card card-border w-full shadow-sm"):
                    with doc.div(classes="card-body"):
                        ...
                        if customer.stripe_customer_id:
                            ...
                            with doc.p(classes="text-gray-500"):
                                doc.text("No Stripe customer linked")

                        with doc.div(classes="mt-4"):
                            with doc.div(classes="flex items-center gap-2"):
                                with doc.span(classes="font-semibold"):
                                    doc.text("Email Verified:")
            ...
            with doc.div(classes="mt-8"):
                ...
                if subscriptions:
                    ...
                    with doc.div(classes="text-center py-8 text-gray-500"):
                        doc.text("No subscriptions found")

            # Orders Section
            with doc.div(classes="mt-8"):
                with doc.div(classes="flex items-center gap-4 mb-4"):
                    with doc.h2(classes="text-2xl font-bold"):
                        doc.text(f"Orders ({len(orders)})")
