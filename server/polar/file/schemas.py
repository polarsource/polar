...
class OAuth2ClientLogoFileCreate(FileCreateBase):
    """Schema to create a file to be used as an OAuth2 client logo."""

    service: Literal[FileServiceTypes.oauth_client_logo]
    mime_type: str = Field(
        description=(
            "MIME type of the file. Only images are supported for this type of file."
        ),
...
class OAuth2ClientLogoFileRead(PublicFileReadBase):
    """File to be used as an OAuth2 client logo."""
