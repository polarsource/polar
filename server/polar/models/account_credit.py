...
from sqlalchemy import TIMESTAMP, ForeignKey, Index, Integer, Text, Uuid
...
class AccountCredit(RecordModel):
    ...
    def account(cls) -> Mapped["Account"]:
        return relationship("Account", lazy="raise", back_populates="account_credits")
    ...
    @declared_attr
    def applied_by(cls) -> Mapped["User | None"]:
