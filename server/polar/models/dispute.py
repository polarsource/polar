...
class Dispute(RecordModel):
    ...
    def support_case(cls) -> Mapped["DisputeSupportCase | None"]:
        # The live merchant ↔ support thread for this dispute, if one was opened.
        return relationship(
            "DisputeSupportCase",
            viewonly=True,
            uselist=False,
    ...
    @property
    def support_case_id(self) -> UUID | None:
        return self.support_case.id if self.support_case else None
