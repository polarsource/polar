...
class TestCreate:
    ...
    async def test_valid_surfaces_processor_fee_in_event_metadata(
        self,
        session: AsyncSession,
        save_fixture: SaveFixture,
        customer: Customer,
        ...
        create_refund_fees_mock.return_value = [fee_transaction]
        ...
        assert balance_refund_event.user_metadata["fee"] == 100
