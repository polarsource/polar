...
resource "tfe_variable" "redis_private_link_host_test" {
  key          = "redis_private_link_host"
  category     = "terraform"
  description  = "DNS name of the Render private link to the test Redis"
  sensitive    = false
  workspace_id = data.tfe_workspace_ids.aws.ids["test"]
