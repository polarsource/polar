...
variable "worker_sqs_actors" {
  ...
  type        = string
  default     = "[\"dummy\",\"observability.invariants.enqueue\",\"observability.invariants.check\",\"merchant_migration.precheck\",\"merchant_migration.verify_cards\",\"merchant_migration.cutover\"]"
}
